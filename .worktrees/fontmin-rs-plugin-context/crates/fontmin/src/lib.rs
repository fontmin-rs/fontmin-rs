...
pub use fontmin_core::{Asset, FontFormat, FontMetadata, OutputFormat};
pub use fontmin_css::{CssFontSource, CssOptions};
...
pub use fontmin_plugins::{
    CssPlugin, GlyphPlugin, Otf2TtfPlugin, Svg2TtfPlugin, Svgs2TtfPlugin, Ttf2EotPlugin,
    Ttf2SvgPlugin, Ttf2Woff2Plugin, Ttf2WoffPlugin,
};
...
pub fn inspect(input: &[u8]) -> Result<FontInfo> {
    ...
    let metadata = match format {
        ...
        FontFormat::Woff2 => return Err(FontminError::unsupported("woff2")),
...
mod tests {
    ...
    use super::{
        CssFontSource, CssOptions, Svg2TtfOptions, SvgIcon, Svgs2TtfOptions, convert,
        generate_font_face_css, inspect, svg_font_to_ttf, svgs_to_ttf, woff_to_ttf,
    };
