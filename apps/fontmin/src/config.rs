...
const optionKeys = new Map([
  ['glyph', new Set(['text', 'textFile', 'unicodes', 'gids', 'glyphNames', 'unicodeRanges', 'basicText', 'hinting', 'trim', 'keepNotdef', 'retainGids', 'retainGlyphNames', 'retainLegacyCmap', 'retainSymbolCmap', 'keepLayout', 'layoutFeatures', 'layoutScripts', 'layoutLanguages', 'nameIds', 'nameLanguages', 'dropTables', 'passThroughTables', 'missingGlyphs', 'clone', 'preserveHinting'])],
