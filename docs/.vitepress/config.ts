        ...
        sidebar: [
          ...
          },
          {
            items: [
              ...
              { link: '/architecture', text: 'Architecture' },
              { link: '/benchmarks', text: 'Performance Policy' },
              { link: '/cache', text: 'Cache Semantics' },
              { link: '/compatibility', text: 'Compatibility Evidence' },
              { link: '/dependency-audit', text: 'Dependency & Size Audit' },
              { link: '/contracts', text: 'Public Contracts' },
              { link: '/deprecation', text: 'Deprecation Policy' },
              { link: '/support', text: 'Support Policy' },
        ...
        sidebar: [
          ...
          },
          {
            items: [
              ...
              { link: '/zh/benchmarks', text: '性能策略' },
              { link: '/zh/cache', text: '缓存语义' },
              { link: '/zh/compatibility', text: '兼容性证据' },
              { link: '/zh/dependency-audit', text: '依赖与体积审计' },
              { link: '/zh/contracts', text: '公开契约' },
              { link: '/zh/deprecation', text: '弃用策略' },
              { link: '/zh/support', text: '支持策略' },
              { link: '/zh/troubleshooting', text: '故障排查' },
