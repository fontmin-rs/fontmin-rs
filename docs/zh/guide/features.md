...
当前开发重点是发布加固、改进 diagnostics、性能优化，以及覆盖更多 Fontmin 兼容能力。稳定版本的具体准入条件记录在[迈向 1.0 的路线图](../roadmap)中，更深层的设计背景仍保留在[设计文档](../../fontmin-rs-design)；维护者可以使用[发布准备清单](../../releasing)检查候选版本是否达到发布门槛。
